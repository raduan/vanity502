    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createDataModalLabel">Create New Wishlistdetail</h5>
           ...
           <div class="modal-body">
            ...
            <div class="form-group">
                <label for="wishlist_id"></label>
                <input wire:model="wishlist_id" type="text" class="form-control" id="wishlist_id" placeholder="Wishlist Id">@error('wishlist_id') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
